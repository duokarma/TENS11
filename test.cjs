...
async function run() {
  ...
  fs.writeFileSync('C:/Users/Moizd/.gemini/antigravity/brain/a06608ef-6f40-42bf-856e-d0b2fc54b3f1/scratch/TEN11_Invoice_TEST.pdf', Buffer.from(pdfData));
  console.log('PDF saved to scratch directory.');
}
